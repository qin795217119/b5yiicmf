            ...
            <div class="swiper-wrapper">
                <?php foreach($bannerList as $banner){?>
                    <div class="swiper-slide">
                        <a href="<?=$banner['linkurl']?:'javascript:;'?>" style="background-image: url(<?=$banner['firstimg']?>)" target="_blank"></a>
                    </div>
                <?php } ?>
            </div>
            <!-- Add Pagination -->
...
<div class="b5_index_content02">
    <div class="con_container">
        ...
        <div class="b5_con2_right01">
            <img src="<?= yii\helpers\Url::to('@appweb/public/static/pc/site/default/images/img01.jpg') ?>">
        </div>
    </div>
</div>
<script>
