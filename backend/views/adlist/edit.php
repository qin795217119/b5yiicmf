...
<form class="form-horizontal m" id="form-redtype-edit">
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'formselect|推荐位置','extend'=>['name'=>'parent_id','required'=>1,'sm'=>'2','data'=>$this->params['adposList'],'showvalue'=>'id','showname'=>'title','place'=>'','class'=>'select2','id'=>'adtype','tips'=>'','info'=>$info]])?>
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'image|图片信息','extend'=>['name'=>'imgarr','id'=>'adlistimgbtn','multi'=>'true','sm'=>2,'tips'=>'','drag'=>'true','cat'=>'adlist','data'=>$info['imglist']]])?>
