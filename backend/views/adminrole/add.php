<div class="col-sm-12 search-collapse">
    <form id="role-form">
        ...
        <div class="select-list">
            <ul>
                <li><?= \common\widgets\FormInput::widget(['name'=>'input|登录名称','extend'=>['name'=>'like[username]']])?>
                </li>
                <li>
    ...
    <script>
        $(function () {
            var options = {
                modalName: "人员",
                sortName:'id',
                url: '<?= \yii\helpers\Url::toRoute('tree')?>',
                showSearch: false,
                showRefresh: false,
                showToggle: false,
                showColumns: false,
        ...
        function submitHandler() {
            ...
            var data = { "role_id": $("#role_id").val(), "admin_id": rows.join() };
