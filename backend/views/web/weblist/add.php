...
<form class="form-horizontal m" id="form-weblist-add">
    <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'catid','type'=>'hidden','id'=>'treeId','value'=>$this->params['catInfo']['id']]])?>
    ...
    <div class="form-group mb0">
        ...
        <div class="col-sm-3 mb15">
            <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'froms','class'=>'form-control']])?>
        </div>
        <label class="col-sm-3 control-label">编辑作者：</label>
        <div class="col-sm-3 mb15">
            <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'author','class'=>'form-control']])?>
        </div>
    </div>
    <?= \common\widgets\FormInput::widget(['name'=>'formtextarea|信息简介','extend'=>['name'=>'remark','sm'=>'2','tips'=>'为空时自动截取内容的前100个字符']])?>
    <div class="form-group mb0">
        <label class="col-sm-2 control-label">发布时间：</label>
        <div class="col-sm-3 mb15">
            <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'subtime','class'=>'form-control','id'=>'subtime','readonly'=>'']])?>
        </div>
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'forminput|外链地址','extend'=>['name'=>'linkurl','sm'=>'2','tips'=>'详情为第三链接时，点击跳转到改地址']])?>
    <?= \common\widgets\FormInput::widget(['name'=>'image|图片信息','extend'=>['name'=>'imglist','id'=>'weblistimgbtn','multi'=>'true','sm'=>2,'tips'=>'默认第一张为该信息的缩略图','cat'=>'weblist','drag'=>'true']])?>
    <div class="form-group">
        <label class="col-sm-2 control-label">图文内容：</label>
        <div class="col-sm-9">
            <?= \common\widgets\FormInput::widget(['name'=>'textarea','extend'=>['name'=>'content','class'=>'summernote_content hide']])?>
