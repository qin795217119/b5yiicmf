            ...
            <div class="col-sm-12 search-collapse">
                <form id="role-form">
                    ...
                    <div class="select-list">
                        <ul>
                            <li><?= \common\widgets\FormInput::widget(['name'=>'input|内容标题','extend'=>['name'=>'like[title]']])?></li>
                            <li><?= \common\widgets\FormInput::widget(['name'=>'select|发布状态','extend'=>['name'=>'where[status]','value'=>'','place'=>'所有']])?></li>
                            <li>
...
<?php $this->beginBlock('script'); ?>
    <script>
        var struct_indexUrl="<?=\yii\helpers\Url::toRoute('webcat/index')?>";
        var struct_treeUrl=urlcreate("<?=\yii\helpers\Url::toRoute('webcat/tree')?>","root=0");
        $(function () {
