...
<form class="form-horizontal m" id="form-webad-edit">
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'formselect|推荐位置','extend'=>['name'=>'pos_id','required'=>1,'sm'=>'2','data'=>$this->params['posList'],'showvalue'=>'id','showname'=>'title','place'=>'','class'=>'select2','id'=>'pos_id','info'=>$info]])?>
    <?= \common\widgets\FormInput::widget(['name'=>'forminput|信息标题','extend'=>['name'=>'title','required'=>1,'sm'=>'2','info'=>$info]])?>
    <?= \common\widgets\FormInput::widget(['name'=>'forminput|外链地址','extend'=>['name'=>'linkurl','sm'=>'2','info'=>$info]])?>
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'image|图片信息','extend'=>['name'=>'imglist','id'=>'adlistimgbtn','multi'=>'true','sm'=>2,'tips'=>'','cat'=>'webad','drag'=>'true','info'=>$info]])?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'text_rich','type'=>'hidden','class'=>'summernote_content','info'=>$info]])?>
