<div class="col-sm-12 search-collapse">
    <form id="role-form">
        <div class="select-list">
            <ul>
                <li><?= \common\widgets\FormInput::widget(['name'=>'select|字典类型','extend'=>['name'=>'where[type]','id'=>'dictType','class'=>'select2','data'=>$this->params['typelist'],'showvalue'=>'type','showname'=>'name','place'=>'所有字典','value'=>$input['type']??'']])?></li>
