...
<form class="form-horizontal m" id="form-dictdata-edit">
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'formselect|字典类型','extend'=>['name'=>'parent_id','required'=>1,'data'=>$this->params['typeList']??[],'showvalue'=>'id','showname'=>'name','place'=>'','class'=>'select2','info'=>$info]])?>
