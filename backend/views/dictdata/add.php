...
<form class="form-horizontal m" id="form-dictdata-add">
    <?= \common\widgets\FormInput::widget(['name'=>'formselect|字典类型','extend'=>['name'=>'parent_id','required'=>1,'data'=>$this->params['typeList']??[],'showvalue'=>'id','showname'=>'name','place'=>'','value'=>$input['id']??'','class'=>'select2']])?>
