...
<form class="form-horizontal m" id="form-admin-edit">
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'struct','type'=>'hidden','id'=>'treeId','value'=>$info['structid']]])?>
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'roles','id'=>'roles','type'=>'hidden','value'=>$info['roleid']]])?>
    <?= \common\widgets\FormInput::widget(['name'=>'formcheckbox|角色分组','extend'=>['name'=>'role','data'=>$this->params['rolelist'],'value'=>$info['roleid']]])?>
