...
<?= \common\widgets\Asset::widget(['type'=>['jquery-layout','ztree']])?>
    ...
    <div class="container-div">
        <div class="row">
            <div class="col-sm-12 search-collapse">
                <form id="role-form">
                    <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['name'=>'structId','id'=>'structId','type'=>'hidden']])?>
                    <div class="select-list">
                        <ul>
                            <li><?= \common\widgets\FormInput::widget(['name'=>'input|人员名称','extend'=>['name'=>'like[realname]']])?></li>
                            <li><?= \common\widgets\FormInput::widget(['name'=>'input|登录名','extend'=>['name'=>'where[username]']])?></li>
                            <li><?= \common\widgets\FormInput::widget(['name'=>'select|人员状态','extend'=>['name'=>'where[status]','value'=>'','place'=>'所有']])?></li>
                            <li>
...
<?php $this->beginBlock('script'); ?>
    <script>
        var struct_indexUrl='<?= \yii\helpers\Url::toRoute('struct/index')?>';
