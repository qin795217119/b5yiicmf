<div class="col-sm-12 search-collapse">
    <form id="role-form">
        <div class="select-list">
            <ul>
                <li><?= \common\widgets\FormInput::widget(['name'=>'input|角色名称','extend'=>['name'=>'like[name]']])?></li>
                <li><?= \common\widgets\FormInput::widget(['name'=>'input|权限字符','extend'=>['name'=>'where[rolekey]']])?></li>
                <li><?= \common\widgets\FormInput::widget(['name'=>'select|角色状态','extend'=>['name'=>'where[status]','value'=>'','place'=>'所有']])?></li>
                <li>
...
<?php $this->beginBlock('script'); ?>
    <script>
        ...
        function authUser(roleId) {
            var url = "<?=\yii\helpers\Url::toRoute('adminrole/index')?>";
