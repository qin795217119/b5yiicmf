...
<form class="form-horizontal m" id="form-roleauth-add">
    ...
    <?= \common\widgets\FormInput::widget(['name'=>'input','extend'=>['type'=>'hidden','name'=>'treeId','id'=>'treeId','value'=>$menuList]])?>
...
<?php $this->beginBlock('script'); ?>
    <script>
        $(function() {
            var url = urlcreate('<?=\yii\helpers\Url::toRoute(['menu/tree'])?>','root=0');
            var options = {
                id: "menuTrees",
                url: url,
                ismult:true,
