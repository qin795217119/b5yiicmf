...
<div class="lockscreen-wrapper">
    ...
    <div class="lockscreen-item">
        <div class="lockscreen-image">
            <img src="<?= yii\helpers\Url::to('@web/static/images/profile.jpg')?>" class="img-circle" alt="User Image">
        </div>
...
<script src="<?= yii\helpers\Url::to('@web/static/plugins/three-js/three.min.js')?>"></script>
