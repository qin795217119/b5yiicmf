...
<div class="lockscreen-wrapper">
    ...
    <div class="lockscreen-item">
        <div class="lockscreen-image">
            <img src="<?= yii\helpers\Url::to('@appweb/public/static/admin/images/profile.jpg') ?>" class="img-circle" alt="User Image">
        </div>
    ...
    <div class="text-center">
        <a href="<?=\yii\helpers\Url::toRoute('public/logout')?>">退出重新登陆</a>
    </div>
</div>
...
<script src="<?= yii\helpers\Url::to('@appweb/public/static/plugins/three-js/three.min.js') ?>"></script>
...
<script >
    ...
    function unlock() {
        ...
        var config = {
            url: "<?=\yii\helpers\Url::toRoute('lockscreen')?>",
            type: "post",
            dataType: "json",
            ...
            success: function(result) {
                if (result.code == web_status.SUCCESS) {
                    location.href = "<?=\yii\helpers\Url::toRoute('index/index')?>";
                } else {
