...
<?= \common\widgets\Asset::widget(['type'=>['cropper']])?>
<style>
...
<script>
    ...
    function submitHandler() {
        if ($("#image").attr("src") == null) {
            ...
            sendFile(createImgUrl,{file_name:filename,cat:cat,water:water},function (result) {
                var html =  b5uploadimghtml(result.path,name,result.url);
