...
<?= \backend\extend\widgets\Asset::widget(['type'=>['beautifyhtml','jquery-ui']])?>
            ...
            <div class="ibox-content">
                ...
                <form role="form" class="form-horizontal m-t">
                    ...
                    <div class="form-group draggable">
                        ...
                        <div class="col-sm-9">
                            <label class="check-box"><input type="checkbox" value="option1" id="inlineCheckbox1">选项1</label>
                            <label class="check-box"><input type="checkbox" value="option2" id="inlineCheckbox2">选项2</label>
                            <label class="check-box"><input type="checkbox" value="option3" id="inlineCheckbox3">选项3</label>
                        </div>
                    </div>
                    <div class="form-group draggable">
                    ...
                    <div class="form-group draggable">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control time-input" value="2018-04-20">
                    ...
                    <div class="form-group draggable">
                        <div class="col-sm-12 col-sm-offset-4">
                            <button type="button" class="btn btn-sm btn-primary" onclick="submitHandler()">提交</button>
                            <button onclick="$.modal.close()" class="btn btn-sm btn-danger" type="button">关闭</button>
                        </div>
                    </div>
                </form>
