...
<form class="form-horizontal m" id="form-edit">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <?=\backend\extend\widgets\Upload::widget(['type'=>'img','name'=>'img_upload','extend'=>['cat'=>'demo','link'=>1,'data'=>$info['img'],'tips'=>'格式为jpg,jpeg,png,gif；大小不能超过10M']])?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <?=\backend\extend\widgets\Upload::widget(['type'=>'img','name'=>'imgs_upload','extend'=>['link'=>1,'cat'=>'demo', 'multi'=>5,'data'=>$info['imgs'],'tips'=>'格式为jpg,jpeg,png,gif；大小不能超过10M；最多上传5张；可拖动排序']])?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <?=\backend\extend\widgets\Upload::widget(['type'=>'img','name'=>'crop_upload','extend'=>['link'=>1,'cat'=>'demo', 'multi'=>2,'crop'=>1,'data'=>$info['crop'],'tips'=>'格式为jpg,jpeg,png,gif；大小不能超过10M；最多上传2张；可拖动排序']])?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <?=\backend\extend\widgets\Upload::widget(['type'=>'video','name'=>'video_upload','extend'=>['cat'=>'demo','data'=>$info['video'], 'tips'=>'格式为mp4；大小不能超过100M']])?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <?=\backend\extend\widgets\Upload::widget(['type'=>'file','name'=>'file_upload','extend'=>['cat'=>'demo',  'link'=>1, 'exts'=>'txt|rar|doc|png','data'=>$info['file'],'tips'=>'格式为txt|rar|doc|png；大小不能超过100M']])?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <?=\backend\extend\widgets\Upload::widget(['type'=>'file','name'=>'files_upload','extend'=>['cat'=>'demo', 'link'=>1,'multi'=>3, 'exts'=>'txt|rar|doc|png','data'=>$info['files'],'tips'=>'格式为txt|rar|doc|png；最大上传3个；大小不能超过100M']])?>
        </div>
    </div>
