...
<form class="form-horizontal m" id="form-add">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="role_key" value="" class="form-control" placeholder="请输入角色标识" required autocomplete="off"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="list_sort" value="0" class="form-control" placeholder="请输入显示顺序" autocomplete="off"/>
        </div>
    </div>
    <div class="form-group">
