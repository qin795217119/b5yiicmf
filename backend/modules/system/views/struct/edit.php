    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="input-group">
                <input type="text" id="treeName" value="<?=$info['parent_name']?>" class="form-control" placeholder="请选择上级组织" readonly autocomplete="off" <?=$info['id']==$root_id?'disabled':''?>/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <label class="radio-box">
                <input type="radio" name="status" value="0" <?=$info['status']=='0'?'checked':''?>/> 有效
            </label>
            <label class="radio-box">
                <input type="radio" name="status" value="1" <?=$info['status']=='1'?'checked':''?>/> 无效
            </label>
        </div>
    </div>
    <div class="form-group">
