...
class Admin extends BaseModel
{
    ...
    public function getStructs(){
        return $this->hasMany(Struct::className(), ['id' => 'struct_id'])->viaTable(AdminStruct::tableName(), ['admin_id' => 'id'])->asArray();
    }

    public function getRoles(){
        return $this->hasMany(Role::className(), ['id' => 'role_id'])->viaTable(AdminRole::tableName(), ['admin_id' => 'id'])->asArray();
    }
