...
) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COMMENT='用户和角色关联表';
...
CREATE TABLE `b5net_admin_struct` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='用户与组织架构关联表';
...
CREATE TABLE `b5net_adposition` (
  ...
  `note` varchar(255) DEFAULT '' COMMENT '备注',
  `width` mediumint(5) DEFAULT '0',
  `height` mediumint(5) DEFAULT '0',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `b5net_menu` VALUES ('107', '通知公告', '3', '10', 'notice/index', '0', 'C', '1', '0', 'admin:notice:index', 'fa fa-bullhorn', '2021-01-03 07:25:11', '2021-01-03 07:25:11', '通知公告');
...
INSERT INTO `b5net_menu` VALUES ('110', '推荐信息', '3', '11', 'adlist/index', '0', 'C', '1', '0', 'admin:adlist:index', 'fa fa-sun-o', '2021-01-03 07:25:11', '2021-01-03 07:25:11', '推荐信息');
